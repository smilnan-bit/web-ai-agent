...
export const Interactive = () => {
  ...
  const mousePadTooltip = interactiveType === InteractiveType.Mouse ? '鼠标友好' : '触摸板友好';
  ...
  return (
    <Popover trigger="custom" placement="topLeft" open={visible} onOpenChange={(open) => setVisible(open)}>
      <Tooltip title={mousePadTooltip} style={{ display: showInteractivePanel ? 'none' : 'block' }}>
