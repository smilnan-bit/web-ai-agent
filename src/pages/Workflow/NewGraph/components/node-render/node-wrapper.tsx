...
export const NodeWrapper: React.FC<NodeWrapperProps> = (props) => {
  ...
  return (
    <>
      <div
        tw="flex flex-col items-start gap-2 self-stretch rounded-[4px] border border-solid border-[#d9d9d9] bg-white shadow-[ 0_2px_8px_0_rgba(0, 0, 0, 0.06)] pb-3 w-[360px] h-auto"
        style={{
          ...meta.wrapperStyle,
          borderColor: form?.state.invalid ? 'red' : selected ? '#4e40e5' : '#D9D9D9',
        }}
        ref={nodeRef}
        draggable
        onDragStart={(e) => {
